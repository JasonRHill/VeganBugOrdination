...
Envfit resultes from Vegan package : 
`r format bug.spp.fit` 
...
Season.mrpp<- mrpp(bugsnms[,6:118], group=samplescoresenv$Season, distance="bray")
...
Ecoregion.mrpp<- mrpp(bugsnms[,6:118], group= samplescoresenv$US_L3NAME, distance="bray")
...
Basin.mrpp<- mrpp(bugsnms[,6:118], group=samplescoresenv$Basin_Code, distance="bray" )
...
#Ecoregion.mrpp<- with(Bugenv, mrpp(bugsnms[,2:126], group= US_L3NAME, distance="bray"))
admin.mrpp<- mrpp(bugsnms[,6:118], group=samplescoresenv$ASSESS_REG, distance="bray" )
...
Sample.mrpp<-mrpp(bugsnms[,6:118], group=samplescoresenv$Gradient, distance="bray" )
...
Stream.mrpp<-mrpp(bugsnms[,6:118], group=samplescoresenv$Order, distance="bray" )
