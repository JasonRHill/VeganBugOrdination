---
title: "Coastal Ordinations for Virginia Reference Streams"
...
bugsnms_coast<-coastalFive%>%
  select("StationID", "Collection.Date", 6:104)
...
NMDSbug_coast <-metaMDS (coastalFive[,6:104],k=3, trymax=1000)
...
Season.mrpp.coastal<- mrpp(bugsnms_coast[,6:104], group=samplescoresenv_coast$Season, distance="bray")
...
Ecoregion.mrpp.coast<- mrpp(bugsnms_coast[,6:104], group= samplescoresenv_coast$US_L3NAME, distance="bray")
...
Basin.mrpp.coast<- mrpp(bugsnms_coast[,6:104], group=samplescoresenv_coast$Basin_Code, distance="bray" )
...
admin.mrpp.coast<- mrpp(bugsnms_coast[,6:104], group=samplescoresenv_coast$ASSESS_REG, distance="bray" )
...
bioregion.mrpp.coast<- mrpp(bugsnms_coast[,6:104], group=samplescoresenv_coast$Bioregion, distance="bray" )
...
Sample.mrpp.coast<-mrpp(bugsnms_coast[,6:104], group=samplescoresenv_coast$Gradient, distance="bray" )
...
Stream.mrpp.coast<-mrpp(bugsnms_coast[,6:104], group=samplescoresenv_coast$Order, distance="bray" )

Stream.mrpp.coast

```

## Stream Order Categories: coastal
...
Cate.mrpp.coast<-mrpp(bugsnms_coast[,6:104], group=samplescoresenv_coast$StreamCate, distance="bray" )
...
## Water Quality Standard Class: Coastal
...
Standard.mrpp.coast<- mrpp(bugsnms_coast[,6:104], samplescoresenv_coast$WQS_CLASS, distance="bray" )
...
basinseason.mrpp.coast<- mrpp(bugsnms_coast[,6:104], samplescoresenv_coast$BioregionSeason, distance="bray" )
...
## Bioregion, Stream Size and Season: coastal
...
biosizeseason.mrpp.coast<- mrpp(bugsnms_coast[,6:104], samplescoresenv_coast$Bioregionsize, distance="bray" )
