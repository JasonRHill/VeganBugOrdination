---
title: "NoncoastalOrdinations-NoMidges"
...
<font size="4"> The document shows a series of NMDS ordinations for reference benthic communities in Virginia with environmental characteristics overlaid to evaluate natural differences in community compositions across Virginia. These NMDS will support the Genus level IBI development process. This version excluded chironomidae larvae because they are ubiquitous in all streams in Virginia. No West Virginia DEP data is used in this analysis.Reference sites were evaluated by regional biologists. 
...
bugs_nomidges <- read_excel('data//benthics_ExcludedTaxaDropped_NoMidges.xlsx', sheet='benthics_ExcludedTaxaDropped_LB')

bugs_nomidges$Collection.Date<-as.Date(bugs_nomidges$Collection.Date, format="%m/%d/%Y")
...
Refbugs <-left_join(bugs_nomidges,Env_noncoast, by=c("StationID", "Collection.Date"))%>%
  subset(`X`=="Ref")%>%
  subset(Season != "Outside Sample Window")



Noncoastal<-unique(Refbugs[ , 1:411])
...
NMDSbug_noncoast <-metaMDS (NoncoastalFive[,6:105],k=3, trymax=1000)
...
Season.mrpp.noncoastal<- mrpp(bugsnms_noncoast[,6:105], group=samplescoresenv_noncoast$Season, distance="bray")
...
Ecoregion.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:105], group= samplescoresenv_noncoast$US_L3NAME, distance="bray")
...
Basin.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:105], group=samplescoresenv_noncoast$Basin_Code, distance="bray" )
...
admin.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:105], group=samplescoresenv_noncoast$ASSESS_REG, distance="bray" )
...
bioregion.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:105], group=samplescoresenv_noncoast$Bioregion, distance="bray" )
...
Sample.mrpp.noncoast<-mrpp(bugsnms_noncoast[,6:105], group=samplescoresenv_noncoast$Gradient, distance="bray" )
...
Stream.mrpp.noncoast<-mrpp(bugsnms_noncoast[,6:105], group=samplescoresenv_noncoast$Order, distance="bray" )
...
Cate.mrpp.noncoast<-mrpp(bugsnms_noncoast[,6:105], group=samplescoresenv_noncoast$StreamCate, distance="bray" )
...
Standard.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:105], samplescoresenv_noncoast$WQS_CLASS, distance="bray" )
...
basinseason.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:105], samplescoresenv_noncoast$BioregionSeason, distance="bray" )
...
biosizeseason.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:105], samplescoresenv_noncoast$Bioregionsize, distance="bray" )
