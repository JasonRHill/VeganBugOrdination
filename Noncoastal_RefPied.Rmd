---
title: "Noncoastal NMDS- With Ref Piedmont Streams"
...
<font size="4"> The document shows a series of NMDS ordinations for reference benthic communities in Virginia with environmental characteristics overlaid to evaluate natural differences in community compositions across Virginia. These NMDS will support the Genus level IBI development process. This analysis is the first run of all of reference sites, reference West Virginia DEP sites, and sites that were deemed reference piedmont sites in Virginia. Reference sites were evaluated by regional biologists. 
...
Noncoastal<-unique(Refbugs[ , 3:416])

#refbugs_noncoast<-write.csv(Env_noncoast, "data\\ReferencePied_WVA_env_noncoast.csv", row.names=FALSE)
...
NMDSbug_noncoast <-metaMDS (NoncoastalFive[,6:107],k=3, trymax=1000)
...
NMDS_axis2<-NMDSbug_noncoast[ , 2:3]
...
bug.sp.fit$vectors
bug.sp.fit.23<-envfit(samplescores_noncoast[ , 2:3], env_continuous[ , 2:9], permutations = 99, na.rm=TRUE) 
bug.sp.fit.23$vectors
bug.sp.fit.31<-envfit(samplescores_noncoast[ , c(1,3)],env_continuous[ , 2:9], permutations = 99, na.rm=TRUE) 
bug.sp.fit.31$vectors
...
p<-ggplot(data = samplescoresenv_noncoast, aes(x = NMDS1, y = NMDS2)) + 
...
outliers<-left_join(samplescoresenv_noncoast, dat, by=c("NMDS1", "NMDS2"))%>%
  subset(in.ell=="FALSE")

outlierbugmatrix<-left_join(outliers,bugs, by=c("StationID", "Collection.Date"))%>%
  unique()
write.csv(outlierbugmatrix, "data/Outlierstations_bugs.csv")
...
coord_cont.23 = as.data.frame(scores(bug.sp.fit.23, "vectors")) * ordiArrowMul(bug.sp.fit.23)
vectors.23<-coord_cont.23[-c(5,6), ]

coord_cont.31 = as.data.frame(scores(bug.sp.fit.31, "vectors")) * ordiArrowMul(bug.sp.fit.31)
vectors.31<-coord_cont.31[-c(5,6), ]

ggplot(data = samplescoresenv_noncoast, aes(x = NMDS1, y = NMDS2, color=Season)) + 
     geom_point(data = samplescoresenv_noncoast, aes(colour =Season), size = 5, alpha = 0.5) + 
     scale_colour_manual(values = c("orange", "steelblue", "black")) + 
  geom_segment(aes(x = 0, y = 0, xend = NMDS1, yend = NMDS2), 
       data = vectors, size =1, alpha = 0.5, colour = "grey30") +
...
ggplot(data = samplescoresenv_noncoast, aes(x = NMDS2, y = NMDS3, color=Season)) + 
     geom_point(data = samplescoresenv_noncoast, aes(colour =Season), size = 5, alpha = 0.5) + 
     scale_colour_manual(values = c("orange", "steelblue", "black")) + 
   geom_segment(aes(x = 0, y = 0, xend = NMDS2, yend = NMDS3), 
       data = vectors.23, size =1, alpha = 0.5, colour = "grey30") +
     geom_text(data = vectors.23, aes(x = NMDS2, y = NMDS3), colour = "grey30", 
       fontface = "bold", label = row.names(vectors)) + 
    stat_ellipse( size=1.5, level=0.90)+
  annotate("text", x=0.8, y=1.3, label= "Stress= 0.18", size=6)+
     theme(axis.title = element_text(size = 14, face = "bold", colour = "grey30"), 
...
ggplot(data = samplescoresenv_noncoast, aes(x = NMDS1, y = NMDS3, color=Season)) + 
     geom_point(data = samplescoresenv_noncoast, aes(colour =Season), size = 5, alpha = 0.5) + 
     scale_colour_manual(values = c("orange", "steelblue", "black")) + 
   geom_segment(aes(x = 0, y = 0, xend = NMDS1, yend = NMDS3), 
       data = vectors.31, size =1, alpha = 0.5, colour = "grey30") +
     geom_text(data = vectors.31, aes(x = NMDS1, y = NMDS3), colour = "grey30", 
       fontface = "bold", label = row.names(vectors.31)) + 
    stat_ellipse( size=1.5, level=0.90)+
  annotate("text", x=0.8, y=1.3, label= "Stress= 0.18", size=6)+
     theme(axis.title = element_text(size = 14, face = "bold", colour = "grey30"), 
     panel.background = element_blank(), panel.border = element_rect(fill = NA, colour = "grey30"), 
...
Season.mrpp.noncoastal<- mrpp(bugsnms_noncoast[,6:107], group=samplescoresenv_noncoast$Season, distance="bray")
...
```{r plot reference type, echo=FALSE, fig.width=12, fig.height=8}


ggplot(data = samplescoresenv_noncoast, aes(x = NMDS1, y = NMDS2, color=JRH_Final_Ref_Cod)) + 
     geom_point(data = samplescoresenv_noncoast, aes(colour =JRH_Final_Ref_Cod), size = 5, alpha = 0.5) + 
     scale_colour_manual(values = c("orange", "steelblue", "black")) + 
  geom_segment(aes(x = 0, y = 0, xend = NMDS1, yend = NMDS2), 
       data = vectors, size =1, alpha = 0.5, colour = "grey30") +
     geom_text(data = vectors, aes(x = NMDS1, y = NMDS2), colour = "grey30", 
  ...
  annotate("text", x=0.8, y=1.3, label= "Stress= 0.18", size=6)+
     ...
     legend.title = element_text(size = 15, face = "bold", colour = "grey30"), 
     legend.text = element_text(size = 15, colour = "grey30")) +
     labs(colour = "Reference Type")



ggplot(data = samplescoresenv_noncoast, aes(x = NMDS2, y = NMDS3, color=JRH_Final_Ref_Cod)) + 
     geom_point(data = samplescoresenv_noncoast, aes(colour = JRH_Final_Ref_Cod), size = 5, alpha = 0.5) + 
     scale_colour_manual(values = c("orange", "steelblue", "black")) + 
   geom_segment(aes(x = 0, y = 0, xend = NMDS1, yend = NMDS2), 
       data = vectors, size =1, alpha = 0.5, colour = "grey30") +
...
Ref.mrpp.noncoastal<- mrpp(bugsnms_noncoast[,6:107], group=samplescoresenv_noncoast$JRH_Final_Ref_Cod, distance="bray")
...
Ecoregion.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:107], group= samplescoresenv_noncoast$US_L3NAME, distance="bray")
...
Basin.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:107], group=samplescoresenv_noncoast$Basin_Code, distance="bray" )
...
admin.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:107], group=samplescoresenv_noncoast$ASSESS_REG, distance="bray" )
...
bioregion.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:107], group=samplescoresenv_noncoast$Bioregion, distance="bray" )
...
Sample.mrpp.noncoast<-mrpp(bugsnms_noncoast[,6:107], group=samplescoresenv_noncoast$Gradient, distance="bray" )
...
Stream.mrpp.noncoast<-mrpp(bugsnms_noncoast[,6:107], group=samplescoresenv_noncoast$Order, distance="bray" )
...
Cate.mrpp.noncoast<-mrpp(bugsnms_noncoast[,6:107], group=samplescoresenv_noncoast$StreamCate, distance="bray" )
...
Standard.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:107], samplescoresenv_noncoast$WQS_CLASS, distance="bray" )
...
trout.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:107], samplescoresenv_noncoast$WQS_TROUT, distance="bray" )
...
basinseason.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:107], samplescoresenv_noncoast$BioregionSeason, distance="bray" )
...
biosizeseason.mrpp.noncoast<- mrpp(bugsnms_noncoast[,6:107], samplescoresenv_noncoast$Bioregionsize, distance="bray" )
...
DT<- data.table(
  Grouping<- c("Season", "Reference Type", "Ecoregion", "Basin", "Admin Region", "Bioregion", "Sample Method", "Stream Order", "Stream Order Category", "Water Quality Standards", "Trout", "Bioregion and season", "Bioregion, Size, season"), 
  `A Statistic`<- c(Season.mrpp.noncoastal$A, Ref.mrpp.noncoastal$A, Ecoregion.mrpp.noncoast$A, Basin.mrpp.noncoast$A, admin.mrpp.noncoast$A, bioregion.mrpp.noncoast$A,Sample.mrpp.noncoast$A, Stream.mrpp.noncoast$A, Cate.mrpp.noncoast$A, Standard.mrpp.noncoast$A, trout.mrpp.noncoast$A,basinseason.mrpp.noncoast$A, biosizeseason.mrpp.noncoast$A  )    , 
  `P-value`<- c(Season.mrpp.noncoastal$Pvalue, Ref.mrpp.noncoastal$Pvalue, Ecoregion.mrpp.noncoast$Pvalue, Basin.mrpp.noncoast$Pvalue, admin.mrpp.noncoast$Pvalue, bioregion.mrpp.noncoast$Pvalue, Sample.mrpp.noncoast$Pvalue, Stream.mrpp.noncoast$Pvalue, Cate.mrpp.noncoast$Pvalue, Standard.mrpp.noncoast$Pvalue, trout.mrpp.noncoast$Pvalue, basinseason.mrpp.noncoast$Pvalue, biosizeseason.mrpp.noncoast$Pvalue  )
)
